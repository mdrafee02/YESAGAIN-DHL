...
FIXED = {
    ...
    "product_code_api_local_uae": "N",   # DHL API value for local UAE-to-UAE shipments
...
# ── Per-product-type customs/packaging profiles ────────────────────────────
# Falls back to "laptop" (the original hardcoded values) for anything that
# doesn't match a known keyword, so every order type already shipping
# correctly today is completely unaffected by this change.
PRODUCT_PROFILES = {
    "laptop": {
        "contents"  : "Used laptop",
        "item_desc" : "Used laptop",
        "commodity" : "8471.49.0000",   # confirmed — matches your DHL Product/Item List
        "weight"    : 1.5, "length": 35, "width": 30, "height": 7,
        "item_net"  : 1.3, "item_gross": 1.5,
    },
    "phone": {
        "contents"  : "Used phone",
...
def detect_product_profile(sku="", product_name=""):
    """
    Pick the correct customs/packaging profile. Prefers the SKU prefix
    (confirmed from real order data: "IP-" = iPhone, "AW-" = Apple Watch)
    since it's far more reliable than free-text product name. Falls back
    ...
    if "watch" in name:
        return PRODUCT_PROFILES["watch"]
    return PRODUCT_PROFILES["laptop"]
 
SA_VALID_CITIES = {
    "ABHA", "ABQAIQ", "ABU ARISH", "ABU HADRIYAH",
    "AFIF", "AFLAJ", "AHAD MASARAH", "AHAD ROFAIDAH",
    "AIN DAR", "AJFAR", "AJYAD", "AL ANBARIYA",
    "AL ARIDHAH", "AL ARISA", "AL ASIYAH", "AL ATAWILAH",
    "AL AWALY", "AL AYSS", "AL BADI' WAL QARAFI", "AL BAHA",
    "AL BAHAR", "AL BASHAIR", "AL BIJADIYAH", "AL BUSAITA",
    "AL GAZAZ AL BALAD", "AL GEWAIZAH", "AL GHALFAQ", "AL GHAT",
    "AL GHAZAH", "AL GHAZALAH", "AL GOZ", "AL HAET",
    "AL HAJOUN", "AL HALILAH", "AL HAREEQ", "AL HARJAH",
    "AL HASA", "AL HURRA AL SHARQYA", "AL JISHSHAH", "AL JOUF",
    "AL JUHAIMA", "AL JUMUM", "AL KHARJ", "AL KHARMA ASH SHAMALIYAH",
    "AL KHOBAR", "AL LITH", "AL LITH TOWN", "AL MAHD",
    "AL MANDAQ", "AL MASFALAH", "AL MAWYA", "AL MIKHWA",
    "AL MOYAN", "AL MUBARRAZ", "AL MUDHAYLIF", "AL MUTHEILIEF",
    "AL NABHANYA", "AL NAMASS", "AL OLA", "AL OTAIBYA",
    "AL OYOUN", "AL QASAB", "AL QASSIM", "AL QAWZIYAH",
    "AL QUAARA", "AL RAFAYE", "AL RAIN", "AL RASS",
    "AL SAHNA", "AL SAYEL AL AKBAR", "AL SHANAN", "AL SHUHADA",
    "AL SUHEIMI", "AL WADYAYN", "AL WAJH", "AL YATMA",
    "AL ZAHER", "AL-JARF", "AL-KHAMISAH", "ALDHALAEUH ALSHAMALIUH",
    "ALFAYIZIA", "ALRAYAN", "ANAQ", "AQEEQ",
    "ARADAH", "ARAR", "ARTAWIAH", "AYOON AL JAWA",
    "BADAYAH", "BADR", "BAEISH", "BAGADIA",
    "BAHA", "BAHRA", "BALJURSHI", "BALLASMAR",
    "BANI AMMR", "BAQAA", "BAREQ", "BATHA BORDER",
    "BEISH", "BISHA", "BRAZAN", "BUKAYRIA",
    "BURAIDAH", "DALEMIYA", "DAMAD", "DAMMAM",
    "DARB", "DAWADMI", "DAWMAT AL JANDAL", "DHABAB",
    "DHAHRAN", "DHAHRAN AL JANOUB", "DHOBBAT", "DHUKNA",
    "DHULUM", "DILAM", "DUBA", "DURMA",
    "DURYA", "ESKAN", "FAWARA", "GASSIM",
    "GELLA", "GIZAN", "GURAYAT", "HABUNA",
    "HADA", "HAFAR AL BATIN", "HAIL", "HALAT AMMAR",
    "HANAKIYAH", "HAQL", "HARADH", "HAWDAT SUDAIR",
    "HAWDAT TAMIM", "HAYET", "HAYIR", "HELBAN",
    "HIJAZ", "HIJRAT LABAN", "HITEEM", "HOFUF",
    "HOTA BIN TAMIM", "HOTA SUDHAIR", "HURAIMALA", "IMAM UNIVERSITY",
    "JABAL AL NOOR", "JAFAR", "JALAJIL", "JAMJOOM",
    "JARDA", "JAREER", "JEDDAH", "JUBAIL",
    "JUBBAH", "JUHAIMIA", "KAFA", "KHABRA",
    "KHAFJI", "KHAIBAR", "KHALIDYA", "KHAMIS MUSHAYAT",
    "KHAZZAN", "KHUBAIB", "KHURAIS", "KHURMA",
    "KHUTTA", "MAHAYIL ASEER", "MAJARDEH", "MAJMAAH",
    "MAKKAH", "MANDAQ", "MANFOUAH", "MANFOUHA",
    "MANIFA", "MATHER", "MAWQEQ", "MAZRUEYA",
    "MEDINA", "MEGAIBRAH", "MIDHNAB", "MOGHARAZAT",
    "MOQAQ", "MUBARRAZ", "MUNAKHAH", "MUTAMARAT",
    "MUZAMMIA", "NABANIYA", "NAFA", "NAIM",
    "NAJIH AL JANUBI", "NARIYA", "NEJRAN", "NEOM CITY",
    "NESRIYAH", "NEW SHIMAISY", "OQLAH AL SUQOUR", "OSHAIGER",
    "OYOON", "QAISUMAH", "QARYAT AL OLAYA", "QATIF",
    "QILWAH", "QUBA", "QUBBA", "QUNFUDAH",
    "QUWAYIAH", "RABIGH", "RAFHA", "RAHIMAH",
    "RAHWA AL BAR", "RANIA", "RAS AL KHAIR", "RAS TANURA",
    "REJAL ALMAA", "RIYADH", "RIYADH ALKHBRA", "ROWADA",
    "ROWAIDA", "RUMAH", "RUWAIDAH", "SABTALAIA",
    "SABYA", "SAFA", "SAFANIYAH", "SAFRA",
    "SAFWA", "SAIHAT", "SAJIR", "SAKAKAH",
    "SALAMAH", "SALWA", "SAMAH", "SAMASHIYA",
    "SAMTAH", "SARAR", "SARAT ABIDAH", "SHAHQRA",
    "SHAMALI", "SHAMSAN", "SHARI", "SHARURAH",
    "SHOAIBA", "SIAHAT", "SITTEN", "SOUQ ALAHAD",
    "SULAYYIL", "SUMEIRA", "TABUK", "TAIF",
    "TANDAHA", "TANUMA", "TARUT ISLAND", "TAWOON",
    "TAYMAH", "THADIQ", "THAREEB", "THATLEETH",
    "THOMAIR", "THOWAL", "TOUGABAH", "TURAIF",
    "TURBAH AL SHAMAL", "UDILLIYAH", "UM AL QURA", "UM AL SAHEK",
    "UMLUJJ", "UNAYZAH", "UQLAQ AL SUGGUR", "UYENAH",
    "WADI AL DAWASIR", "WADI HASHBEL", "WOROOD", "YABRIN",
    "YANBU", "ZAWIYAH", "ZDIHAR", "ZILFI",
}
...
def get_dhl_product_code(origin_country, destination_country):
    """Return 'N' for local UAE-to-UAE shipments, 'P' for all international."""
...
def upload_docs_to_airtable(record_id, order_number, res_data, max_retries=3):
    ...
    No external services, no expiry, no network blocks.
    Airtable stores the file immediately and permanently.
    """
    if not record_id:
...
# DHL country-specific tracking locale (for the console log only).
# The actual "Shipment Tracking URL" field in Airtable is a FORMULA field
# that builds this same link automatically — so we never write it here.
DHL_TRACKING_LOCALE = {
    ...
    "US":"us-en","CA":"ca-en","AU":"au-en","JP":"jp-en","CN":"cn-en",
    "HK":"hk-en","SG":"sg-en","IN":"in-en","ZA":"za-en","TR":"tr-en",
}

def dhl_tracking_url_for(country, tracking_number):
    """Return the country-specific DHL tracking URL for a given AWB (log only)."""
...
def mark_label_created_in_airtable(record_id, order_number, tracking_number, country="AE"):
    """
    PATCH Step 3 — ticks 'Shipment Label Created'.

    NOTE: 'Shipment Tracking URL' is a FORMULA field in Airtable and builds
    the country-specific tracking link automatically from the tracking number.
    We do NOT write it here (writing a formula field returns HTTP 422).
    The URL below is built only for the console log so it matches Airtable.
    ...
    Args:
        ...
        country         – 2-letter destination country code (default AE), log only
    ...
    # Country-specific URL — for the console log only (Airtable's formula
    # field generates the real one). Matches what you see in Airtable.
    dhl_tracking_url = dhl_tracking_url_for(country, tracking_number)
    ...
    if resp is None:
        ...
        return False
    if resp.status_code == 200:
        print(f"   ✅ Step 3 — Checkbox ticked ✅ | Tracking URL ({country})  (Order: {order_number})")
...
def transform(df, ya_rma_map=None, crs_rma_map=None, price_map=None):
    ...
    for _, r in df.iterrows():
        ...
        product_sku  = r.get("Sales Order Lines Product SKU", "")
        ...
        rows.append({
            ...
            "Total Weight (Required)"                   : round(qty * pp["weight"], 2),
            ...
            "Summary of Contents"                       : pp["contents"],
            ...
            "ITEM DESCRIPTION"                          : pp["item_desc"],
            "ITEM COMMODITY"                            : pp["commodity"],
            "ITM QTY"                                   : qty,
            "ITM UNITS"                                 : F["item_units"],
            "ITM VALUE"                                 : round(declared_val, 2),
            "ITM CRNCY"                                 : F["currency"],
            "ITM NET"                                   : pp["item_net"],
            "ITM GRSS"                                  : pp["item_gross"],
            ...
            "Account Number (Duty Tax)"                 : int(duty_acc) if duty_acc is not None else "",
        })
...
def build_dhl_payload(row):
    ...
    payload = {
        ...
        "productCode": get_dhl_product_code(party["Country"], country),
        "accounts": [
        ...
        "content": {
            "packages": [
                ...
                {
                    "weight"    : float(row.get("ITM GRSS", F["weight"])),  # per-unit weight (not total)
                    "dimensions": {"length": row.get("LENGTH", F["length"]), "width": row.get("WIDTH", F["width"]), "height": row.get("HEIGHT", F["height"])},
                    "customerReferences": [
            ...
            **({} if is_domestic else {
                "exportDeclaration": {
                    "lineItems": [
                        {
                            "number"             : 1,
                            "description"        : row.get("ITEM DESCRIPTION", F["item_desc"]),
                            "price"              : total_val,
                            "priceCurrency"      : str(row.get("Declared Value Currency (Required)", F["currency"])),
                            "commodityCodes"     : [
                                {"typeCode": "outbound", "value": row.get("ITEM COMMODITY", F["commodity"])},
                                {"typeCode": "inbound",  "value": row.get("ITEM COMMODITY", F["commodity"])},
                            ],
                            "exportReasonType"   : "permanent",
                            "manufacturerCountry": F["origin"],
                            "weight"             : {"netValue": round(float(row.get("ITM NET", F["item_net"])) * itm_qty, 3), "grossValue": round(float(row.get("ITM GRSS", F["item_gross"])) * itm_qty, 3)},
...
def book_return_label(original_awb):
    """
    Book a DHL return label by looking up the original shipment AWB
    in Sales Order Lines, then swapping shipper/receiver.
    Works for domestic AE and all international destinations.
    """
    original_awb = str(original_awb).strip()
    print(f"\n📦 Booking return label for AWB: {original_awb}")

    def _str(val):
        """Safely convert Airtable field value to string — handles lists."""
        if isinstance(val, list):
            return str(val[0]).strip() if val else ""
        return str(val).strip() if val is not None else ""

    # ── Step 1: Find order in Sales Order Lines by AWB ────────────────────
    cfg     = TABLE_CONFIG["sales_order_lines"]
    formula = f'{{Sales Order Tracking Number}}="{original_awb}"'
    df = fetch_table(
        base_id=cfg["base_id"], table_id=cfg["table_id"],
        view_id=None, label="SOL (return lookup)",
        api_key=cfg["api_key"], filter_formula=formula,
    )
    if df.empty:
        ...
        df = fetch_table(
            ...
            view_id=None, label="Orders (return fallback)",
    ...
    record_id    = str(row.get("_airtable_id", "")).strip()
    order_number = _str(row.get("Sales Order Number") or
                        row.get("Shipment Reference 1") or original_awb)

    pp = detect_product_profile(
        _str(row.get("Product SKU") or row.get("Sales Order Lines Product SKU") or ""),
        _str(row.get("Sales Product Name (from Sales Order Lines)") or
             row.get("Sales Product Name") or "")
    )
    if pp is not PRODUCT_PROFILES["laptop"]:
        print(f"   📦 Return item detected as: {pp['contents']}")

    # Country — already 2-letter code in SOL (use _str to handle list fields)
    dest_country = _str(row.get("Shipping Country") or
                        row.get("Country Code (Ship TO) (Required)") or "AE").upper()
    if len(dest_country) > 2:
        dest_country = resolve_country_code(dest_country)
    dest_country = dest_country[:2] or "AE"

    is_domestic = (dest_country == "AE")

    # Address fields — use _str() to safely handle Airtable list/lookup fields
    cust_name  = clean_text(_str(
        row.get("Shipping Name") or
        row.get("Name (Ship TO) (Required)") or "Customer"
    ))[:35] or "Customer"

    cust_addr1 = clean_text(_str(
        row.get("ShippingAddress1") or
        row.get("Shipping address 1") or
        row.get("Address 1 (Ship TO) (Required)") or "NA"
    ))[:45] or "NA"

    cust_addr2 = clean_text(_str(
        row.get("ShippingAddress2") or
        row.get("Shipping address 2") or
        row.get("Address 2 (Ship TO)") or ""
    ))[:45]

    cust_city  = clean_text(_str(
        row.get("ShippingCity") or
        row.get("Shipping City") or
        row.get("City (Ship TO) (Required)") or "NA"
    )) or "NA"

    cust_zip   = _str(
        row.get("ShippingPostCode") or
        row.get("Shipping Postcode") or
        row.get("ZIP Postal Code (Ship TO)") or ""
    )
    cust_zip   = clean_postal_code(cust_zip, dest_country) or "00000"

    raw_phone  = re.sub(r"\D", "", _str(
        row.get("Telephone") or
        row.get("Phone Number (Ship TO) (Required)") or "0000000000"
    )) or "0000000000"
    phone_cc   = str(PHONE_CODES.get(dest_country, "971"))
    cust_phone = raw_phone[len(phone_cc):] if raw_phone.startswith(phone_cc) else raw_phone

    print(f"   Order  : {order_number}")
    print(f"   Country: {dest_country}  Domestic: {is_domestic}")
    print(f"   Name   : {cust_name!r}")
    print(f"   Addr1  : {cust_addr1!r}")
    print(f"   City   : {cust_city!r}")
    print(f"   ZIP    : {cust_zip!r}")
    print(f"   Phone  : +{phone_cc}{cust_phone}")
    ...
    shipper_postal = {
        ...
        "addressLine1": cust_addr1,
    }
    if cust_addr2:
        shipper_postal["addressLine2"] = cust_addr2
    ...
    recv_phone = "+" + str(receiver_party["PhoneCC"]) + re.sub(r"\D", "", str(receiver_party["Phone"]))
        ...
        "customerDetails": {
            "shipperDetails": {
                ...
                "contactInformation": {
                    ...
                    "fullName"   : cust_name,
                    "phone"      : f"+{phone_cc}{cust_phone}"[:25],
                },
            },
            "receiverDetails": {
        ...
        "content": {
            ...
            **({
                "exportDeclaration": {
                    "lineItems": [{
                        "number"             : 1,
                        "description"        : pp["item_desc"],
                        "price"              : 1.0,
                        "priceCurrency"      : FIXED["currency"],
                        "commodityCodes"     : [
                            {"typeCode": "outbound", "value": pp["commodity"]},
                            {"typeCode": "inbound",  "value": pp["commodity"]},
                        ],
                        "exportReasonType"   : "permanent",
                        "manufacturerCountry": FIXED["origin"],
                        "weight"             : {"netValue": pp["item_net"], "grossValue": pp["item_gross"]},
    ...
    ref      = f"RET-{order_number[:15]}-{datetime.now().strftime('%Y%m%d%H%M%S')}"[:36]
    headers  = {
        "Content-Type"                     : "application/json",
        "Accept"                           : "application/json",
        "Message-Reference"                : ref,
        "Message-Reference-Date"           : datetime.now().strftime("%Y-%m-%dT%H:%M:%S GMT+04:00"),
        "Plugin-Name"                      : "YesAgain-Return",
        "Plugin-Version"                   : "1.0",
        "Shipping-System-Platform-Name"    : "Python",
        "Shipping-System-Platform-Version" : "3.12",
        "Shipper-System-Platform-Name"     : "YesAgain",
        "Shipper-System-Platform-Version"  : "1.0",
    }

    try:
        import json as _json
        print(f"   📤 DHL payload: {_json.dumps(payload, indent=2)}")
        resp = requests.post(
            url=f"{base_url}/shipments",
            json=payload,
            auth=(DHL_API_KEY, DHL_API_SECRET),
