...
def _upload_to_temp_host(pdf_bytes, filename):
    ...
    services = [
        {
            # file.io: direct binary URL, single-use, expires 1 day
            "name"     : "file.io",
        ...
        {
            # transfer.sh: direct binary URL via PUT, 14-day expiry
            "name"     : "transfer.sh",
        ...
        {
            # uguu.se: direct binary URL, 48-hour expiry
            "name"     : "uguu.se",
            "url"      : "https://uguu.se/upload",
            "get_link" : lambda r: r.json().get("files", [{}])[0].get("url", ""),
            "field"    : "files[]",
        },
        {
            # 0x0.st: direct binary URL
            "name"     : "0x0.st",
            "url"      : "https://0x0.st",
            "get_link" : lambda r: r.text.strip(),
            "field"    : "file",
